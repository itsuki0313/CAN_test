    ...
    *******************************************************************************/
    uint8 CAN_SendMsgLED(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_LED_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_LED_CALLBACK
                    CAN_SendMsg_LED_Callback();
                #endif /* CAN_SEND_MSG_LED_CALLBACK */
